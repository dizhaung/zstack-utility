...
class BlkCeph(object):
    ...
    def to_xmlobject(self):
        ...
        dev_format = Vm.get_dev_name_format(self.bus_type)
...
class Vm(object):
    ...
    @staticmethod
    def get_dev_name_format(bus_type):
    ...
    def _attach_data_volume(self, volume, addons):
        ...
        def filebased_volume():
            ...
            if volume.useVirtioSCSI:
                ...
                bus_type = self.get_controller_type()
                dev_format = Vm.get_dev_name_format(bus_type)
        ...
        def ceph_volume():
            ...
            def blk_ceph():
                ...
                ic.bus_type = self.get_controller_type()
    ...
    def attach_iso(self, cmd):
        ...
        dev = self.get_target_dev(device_letter)
        bus = self.get_controller_type()
    ...
    def get_target_dev(self, device_letter):
    ...
    def from_StartVmCmd(cmd):
        ...
        def make_cdrom():
            ...
            def makeEmptyCdrom(target_dev, bus, unit):
            ...
            for iso in cmd.bootIso:
                ...
                if iso.path.startswith('ceph'):
                    ic = IsoCeph()
                    ic.iso = iso
                    devices.append(ic.to_xmlobject(cdromConfig.targetDev, default_bus_type, cdromConfig.bus, cdromConfig.unit))
                elif iso.path.startswith('fusionstor'):
                    ic = IsoFusionstor()
                    ic.iso = iso
                    devices.append(ic.to_xmlobject(cdromConfig.targetDev, default_bus_type, cdromConfig.bus, cdromConfig.unit))
        ...
        def make_volumes():
            ...
            def filebased_volume(_dev_letter, _v):
                ...
                if _v.useVirtio:
                    ...
                    dev_format = Vm.get_dev_name_format(default_bus_type)
